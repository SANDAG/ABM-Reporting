...
population_7a = pd.read_sql(
    sql="EXECUTE [fed_rtp_20].[sp_pm_7ab_population] " +
...
destinations = pd.read_sql(
    sql="EXECUTE [fed_rtp_20].[sp_pm_7ab_destinations] " +
        scenario_id + "," + uats,
    con=conn)
...
if uats == "0":
    output_path = scenario_path + "/output/pm_7ab_transit_region.csv"
if uats == "1":
    output_path = scenario_path + "/output/pm_7ab_transit_uats.csv"
